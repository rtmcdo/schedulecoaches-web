-- Migration: Add Subscription Tracking Columns to Users Table (GO Batches Version)
-- Created: 2025-10-21
-- Phase: 6
...
-- Note: Uses GO statements to separate batches (no transaction wrapping)
...
-- Step 2: Backfill coaches (existing = free/demo accounts)
